...
namespace MalbersAnimations.HAP
{
    ...
    public class MeleeCombat : RiderCombatAbility
    {
        ...
        public override WeaponType Type { get { return MalbersAnimations.WeaponType.Melee; } }
        ...
        {
            CheckAttacking();
            if (!isAttacking) RiderMeleeAttack(false);                 //Attack with Left Hand
        }

        public override void SecondaryAttack()
        {
            CheckAttacking();
            if (!isAttacking) RiderMeleeAttack(true);                 //Attack with Left Hand
        }
